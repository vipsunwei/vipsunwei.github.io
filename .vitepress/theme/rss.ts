...
const DOMAIN = "https://vipsunwei.com";
const AUTHOR = {
  name: "SunWei",
  email: "908241555@qq.com",
  link: DOMAIN,
};
const OPTIONS: FeedOptions = {
  title: "SunWei",
  description: "SunWei's Blog",
  id: `${DOMAIN}/`,
  link: `${DOMAIN}/`,
  ...
  author: AUTHOR,
  image: "https://vipsunwei.com/svg/chinese-zodiac/dragon.svg",
  favicon: "https://vipsunwei.com/svg/chinese-zodiac/dragon.svg",
};
